...
class ImageAnnotator(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("ZebraFish Image Annotator")
    ...
    def toggle_sam_assisted(self):
        if not self.current_sam_model:
            QMessageBox.warning(self, "No SAM Model Selected", "Please Select a SAM model before using the SAM-Assisted tool.")
            self.sam_magic_wand_button.setChecked(False)
            return
    ...
    def setup_sidebar(self):
        ...
        # Annotation section
        self.sidebar_layout.addWidget(create_section_header("Select an Annotation Tool"))
    ...
    def apply_theme_and_font(self):
        ...
        self.image_label.setFont(QFont("Comic Sans", font_size))
        self.update()
